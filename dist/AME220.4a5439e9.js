...
})({"3qM0u":[function(require,module,exports,__globalThis) {
...
module.bundle.HMR_BUNDLE_ID = "145ee2c24a5439e9";
"use strict";
...
},{}],"g6mDf":[function(require,module,exports,__globalThis) {
...
},{"chart.js/auto":"a3bOj","./probability.js":"1YMFa","./util.js":"4YnxM","@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT"}],"a3bOj":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
...
},{}],"1YMFa":[function(require,module,exports,__globalThis) {
/* This file contains algorithms needed to generate the probability array. */ /* Design goals: Do as many array operatons in-place as possible. Reduce   */ /* Big-O runtime where possible/applicable. Handle any relevant exceptions.*/ /* Caller will not sanitize input. Make sure to properly validate inputs.  */ /* PUBLIC INTERFACE: Takes a string in the format   */ /* "XXXXdYYYY" where XXXX and YYYY are numbers.     */ /* Takes the input, converts it to a usable form,   */ /* then generates the correct distribution. null    */ /* return indicates improper input format.          */ var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "parseAndProcessInput", ()=>parseAndProcessInput);
function parseAndProcessInput(input) {
    /* Local vars */ let numDiceBuf = "";
    let diceSizeBuf = "";
...
/* PRIVATE */ /* Using a dynamic programming approach, generate an array with */ /* the discrete probability distribution of rolling XXdYY.      */ function generateDistribution(numDice, diceSize) {
    ...
    /* Dynamic Programming loop. Runtime: O(diceSize ^ numDice) */ for(let i = 2; i <= numDice; i++){
        ...
        for(let j = 1; j < distr.length; j++)for(let k = 1; k <= diceSize; k++){
            let totalRoll = j + k;
            newDist[totalRoll] += distr[j];
        }
        distr = newDist;
    }
    /* ref: https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Array/filter */ return occurrencesToProbability(distr.filter((i)=>!Number.isNaN(i)));
}
/* PRIVATE */ /* Divide every elem of distArr by numOccurrences. Sanitize the array. */ function occurrencesToProbability(distArr) {
    let numOccurrences = 0;
    let sanitizedArr = [];
    for(let i = 0; i < distArr.length; i++)if (distArr[i] != NaN && distArr[i] != null) numOccurrences += distArr[i];
    for(let i = 0; i < distArr.length; i++)distArr[i] = distArr[i] / numOccurrences;
    return distArr.filter((i)=>!Number.isNaN(i));
}

},{"@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT"}],"4YnxM":[function(require,module,exports,__globalThis) {
/* Contains extraneous functions needed to create the graph */ /* PUBLIC INTERFACE */ var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "distArrToGraphableArr", ()=>distArrToGraphableArr);
function distArrToGraphableArr(distArr) {
    let parentArr = [];
    for(let i = 1; i < distArr.length; i++){
        let instance = {
            Result: i,
            Probability: distArr[i]
        };
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT"}]},["3qM0u","g6mDf"], "g6mDf", "parcelRequire30ab", {})

//# sourceMappingURL=AME220.4a5439e9.js.map
